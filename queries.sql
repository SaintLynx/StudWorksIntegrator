-- Добавляем в таблицу научных руководителей ФИО преподавателей для формы (обязательно для развертывания)
INSERT INTO supervisors_list (supervisor_name, supervisor_code)
VALUES
